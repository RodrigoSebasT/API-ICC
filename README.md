...
- ### Área superficial de un cilindro circular derecho:
    #### URL
...
- ### Área superficial de un square_pyramid:
    #### URL
    ...
    #### Salida
    Área superficiale de la pirámide cuadrada
